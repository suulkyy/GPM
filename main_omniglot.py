...
class LeNet(nn.Module):
    def __init__(self,taskcla):
        ...
        self.fc1 = nn.Linear(128*self.smid*self.smid,2500, bias=False)
        self.fc2 = nn.Linear(2500,1500, bias=False)
        self.map.extend([1500])
        
        self.taskcla = taskcla
        self.fc3=torch.nn.ModuleList()
        for t,n in self.taskcla:
            self.fc3.append(torch.nn.Linear(1500,n,bias=False))
...
def main(args):
    ...
    from dataloader import omniglot_rotation as data_loader
    ...
    for k,ncla in taskcla:
        ...
        threshold = np.array([0.98] * 5) + task_id*np.array([0.0002] * 5)
