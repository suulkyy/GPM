...
class MLPNet(nn.Module):
    def __init__(self, taskcla, n_hidden=100, n_outputs=10):
        ...
        for t,n in self.taskcla:
            self.fc1.append(torch.nn.Linear(n_hidden,n,bias=False))
...
def main(args):
    ...
    for k,ncla in taskcla:
        ...
        if task_id==0:
            model = MLPNet(taskcla, args.n_hidden, args.n_outputs).to(device)
